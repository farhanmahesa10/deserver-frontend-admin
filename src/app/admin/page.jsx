  ...
  return (
    <div className="p-8 pt-24 w-full">
      ...
      <div
        ...
        className="flex relative w-full bg-yellow-700  mt-5 items-center px-4 py-2 border border-gray-300 rounded-t-md shadow-sm cursor-pointer  hover:bg-yellow-800 transition-all duration-300"
      >
