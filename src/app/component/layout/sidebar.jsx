        ...
        <div className="flex flex-col gap-1">
          ...
          <Collapse isOpened={collapse}>
            <div className="mt-2 flex flex-col gap-2">
              <SidebarComp handleRoute={() => handleRoute("/admin/outlet")} url={url} route={"/admin/outlet"} roleAdmin={`${dataOutlet.role !== "admin pusat" ? "hidden" : ""}`} icon={<IoStorefront />} menuName={"Outlet"} />
